# Work Order: mood-diner still declares versionCode 1
...
- **Finding ID:** `mood-diner-mobile-default-version-code`
- **App:** `mood-diner`
...
3. The acceptance gate above must pass:
   ...
   - `validate-specs*` → `node scripts/harness-status.mjs --strict` no longer reports `mood-diner-mobile-default-version-code`.
