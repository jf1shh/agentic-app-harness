 ...
 *
 * Nothing here is reported off-device: mood-diner makes no network calls at application runtime, and its reservations can carry free-text notes (allergies, health details) per its privacy policy.
 *
