 ...
 *
 * Nothing here is reported off-device. This app's whole promise is that no document or query content leaves the device (§11), so a crash reporter that phoned home would break exactly the guarantee the app exists to make.
 *
