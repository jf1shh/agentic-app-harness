...
export default function WardrobeAnalyzer({ report, garments, destinationCountryCodes }: Props) {
  const { t } = useT();
  ...
  return (
    <div className="glass-panel" style={{ marginTop: '32px', padding: '24px' }}>
      ...
      <h3 style={{ marginBottom: '16px' }}>{t('wearability.digitalCloset')}</h3>
            ...
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
              ...
              {outfit.topper && (
                <div style={{ textAlign: 'center' }}>
                  ...
                  <small>{t('wearability.layer', { name: outfit.topper.name })}</small>
                </div>
              )}
            </div>
          </div>
