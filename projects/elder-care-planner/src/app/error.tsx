 ...
 *
 * Nothing here is reported off-device. This app makes zero network requests and its manifest deliberately omits the INTERNET permission, so a crash reporter that phoned home would contradict both its privacy policy and its Play Data Safety declaration.
 */
